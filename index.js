import{a as S,S as $,i as c}from"./assets/vendor-DOgVoBmD.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))d(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const o of t.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&d(o)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function d(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}})();const E="https://pixabay.com/api/",v="21553593-5dff095819739d8fe44d39f5a";function f(i,s){const a=`${E}?key=${v}&q=${i}&image_type=photo&orientation=horizontal&safesearch=true&per_page=15&page=${s}`;return S.get(a)}function h(i,s){const a=i.map(({webformatURL:d,largeImageURL:e,tags:t,likes:o,views:L,comments:b,downloads:_})=>`
